                  ...
                  <div className="p-2 space-y-1">
                    {subject.sections.map(section => (
                      <button
                        key={section.id}
                        onClick={() => {
                          // Skip flashcards in split screen - they need full screen for flip animation
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {subject.sections.map((section) => {
              ...
              return (
                ...
                >
                  <div className={`relative h-24 bg-gradient-to-br ${subject.gradient} p-4 overflow-hidden`}>
                  ...
                  <div className="p-3">
                    ...
                    <div className="flex items-center justify-between text-xs text-gray-500">
                      <span>{isRead ? 'Completed' : 'Not started'}</span>
    ...
    <div className="mb-8 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border-2 border-blue-200 relative">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-xl p-4 border-2 border-blue-100 hover:border-blue-300 transition-all hover:shadow-md">
          ...
          <div className="text-xs text-blue-600 font-semibold">
            → Click "Open Split View" on any quiz or notes section
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-4 border-2 border-green-100 hover:border-green-300 transition-all hover:shadow-md">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="font-bold text-gray-800">Mark as Complete</h3>
          </div>
          <p className="text-sm text-gray-600 mb-2">
            Track which sections you've read with checkmarks
          </p>
          <div className="text-xs text-green-600 font-semibold">
            → Click the circle button at the top of any section
          </div>
        </div>
        ...
        {/* Feature 6: Worksheets */}
        <div className="bg-white rounded-xl p-4 border-2 border-teal-100 hover:border-teal-300 transition-all hover:shadow-md">
          <div className="flex items-center gap-2 mb-2">
            <ClipboardList className="w-5 h-5 text-teal-500" />
            <h3 className="font-bold text-gray-800">Reveal Answers</h3>
          </div>
          <p className="text-sm text-gray-600 mb-2">
            Try problems first, then reveal step-by-step solutions
          </p>
          <div className="text-xs text-teal-600 font-semibold">
            → Click "Reveal Answer" to see detailed solutions
          </div>
        </div>
      </div>
      ...
      <div className="mt-4 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl p-4 text-white">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="font-semibold mb-1">Pro Study Tip</p>
            <p className="text-sm text-white/90">
              Use split screen to take a quiz while referencing your notes. Mark sections complete as you master them. Aim to unlock all achievements for comprehensive coverage!
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredSubjects.map((subject) => {
              ...
              return (
                ...
                >
                  <div className={`relative h-32 bg-gradient-to-br ${subject.gradient} p-5 overflow-hidden`}>
                    <div className="absolute -top-6 -right-6 w-24 h-24 bg-white/10 rounded-full blur-xl"></div>
                    <div className="absolute -bottom-4 -left-4 w-20 h-20 bg-white/10 rounded-full blur-xl"></div>
                    ...
                    <div className="relative z-10 flex items-start justify-between h-full">
                      ...
                      <div className="w-12 h-12 rounded-lg bg-white/20 backdrop-blur flex items-center justify-center group-hover:scale-110 transition-transform">
